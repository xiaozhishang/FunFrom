...
namespace FunFrom {
	...
	/// ColorPix 摘要
	/// </summary>
	public ref class ColorPix : public System::Windows::Forms::Form
	{
	public:
		ColorPix(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(ColorPix::typeid));
			...
			this->textBox_RGB->MouseEnter += gcnew System::EventHandler(this, &ColorPix::textBox1_MouseEnter);
			this->textBox_RGB->MouseLeave += gcnew System::EventHandler(this, &ColorPix::textBox1_MouseLeave);
			// 
			// funButton
			// 
			...
			this->funButton->MouseEnter += gcnew System::EventHandler(this, &ColorPix::funButton_MouseEnter);
			// 
			// pictureBox_pic
			// 
			...
			this->pictureBox_pic->Click += gcnew System::EventHandler(this, &ColorPix::pictureBox_pic_Click);
			this->pictureBox_pic->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &ColorPix::pictureBox1_MouseDown);
			// 
			// textBoxPicFile
			// 
			...
			this->selectPicButton->Click += gcnew System::EventHandler(this, &ColorPix::selectPicButton_Click);
			// 
			// pictureBox_color
			// 
			...
			this->Name = L"ColorPix";
			this->Text = L"ColorPix";
